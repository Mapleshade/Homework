package ru.kpfu.itis.group11506.searchFile;
...
public class Finder {
	 ...
	 * (startPath)
	 */
	public List findFiles(String startPath) throws Exception {
	 ...
	 */
	public List findFiles(String startPath, String mask) throws Exception {
	 ...
	 * директории (startPath)
	 */
	public List findDirectories(String startPath) throws Exception {
	 ...
	 * (startPath)
	 */
	public List findDirectories(String startPath, String mask) throws Exception {
	 ...
	 * Возвращает true, если найденный объект соответствует регулярному
	 * выражению, false - в противном случае.
	 */
	...
	/**
	 * Этот метод выполняет начальные установки поиска. Затем вызывает метод
	...
	/**
	 * Этот метод выполняет поиск объектов заданного типа. Если, в процессе
	 * поиска, встречает вложенную директорию (папку), то рекурсивно вызывает
	 * сам себя. Результаты поиска сохраняются в параметре res. Текущая
	 * директория - topDirectory. Тип объекта (файл или директория) -
	 * objectType.
	 */
